...
languages['mini'] = Object.assign({}, CLIKE, {
...
Prism.languages.insertBefore('r', 'punctuation', CLIKE)
languages['r'] = Prism.languages.r

Prism.languages.insertBefore('python', 'punctuation', CLIKE)
languages['python'] = languages['py'] = languages['pyjp'] = Prism.languages.python

Prism.languages.insertBefore('javascript', 'punctuation', CLIKE)
languages['js'] = languages['node'] = languages['javascript'] = Prism.languages.javascript

Prism.languages.insertBefore('sql', 'punctuation', CLIKE)
